...
def getWeather():
    try:
        ...
        #ADDD API KEY WEATHER
        api = "https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=1d524f8b973893c6b113d6992a5c2b91"
        ...
        messagebox.showerror("Weather App","Invallid Entry!!")
